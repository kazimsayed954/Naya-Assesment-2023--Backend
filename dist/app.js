...
const makeRoom = (resolve) => {
    ...
    while (rooms === null || rooms === void 0 ? void 0 : rooms.has(newRoom)) {
        newRoom = randRoom();
    }
...
const joinRoom = (player, room) => {
    var _a;
    const currentRoom = rooms === null || rooms === void 0 ? void 0 : rooms.get(room);
    (_a = currentRoom === null || currentRoom === void 0 ? void 0 : currentRoom.players) === null || _a === void 0 ? void 0 : _a.push(player);
};
//Remove the latest player joined from a room's player list
function kick(room) {
    var _a;
    let currentRoom = rooms.get(room);
    (_a = currentRoom === null || currentRoom === void 0 ? void 0 : currentRoom.players) === null || _a === void 0 ? void 0 : _a.pop();
}
//Check how many player is currently in the room
function getRoomPlayersNum(room) {
    return rooms === null || rooms === void 0 ? void 0 : rooms.get(room).players.length;
}
...
function pieceAssignment(room) {
    ...
    (_a = currentRoom.players[0]) === null || _a === void 0 ? void 0 : _a.piece = firstPiece;
    (_b = currentRoom.players[1]) === null || _b === void 0 ? void 0 : _b.piece = lastPiece;
}
    ...
    socket.on("move", ({ room, piece, index }) => {
        try {
            ...
            if (currentPlayer && (currentPlayer === null || currentPlayer === void 0 ? void 0 : currentPlayer.piece) === (currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.getCurrentPlayer())) {
                ...
                if (validMove) {
                    if (currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.checkWinner(piece)) {
                        io.to(room).emit("winner", {
                            gameState: currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.game,
                            id: socket.id,
                        });
                    }
                    else if (currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.checkDraw()) {
                        io.to(room).emit("draw", { gameState: currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.game });
                    }
                    else {
                        io.to(room).emit("update", {
                            gameState: currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.game,
                            turn: currentBoard === null || currentBoard === void 0 ? void 0 : currentBoard.getCurrentPlayer(),
                        });
                    }
                }
                else {
